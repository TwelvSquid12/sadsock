...
$(document).ready(function() 
{
	...
	{
		socket.broadcast.emit('action', { user: username, direction: 'boost' }); 
		document.getElementById("boostIMG").src="art/boost.png";
	});

    $('#fwd_button').on('touchstart', function()
	{
		socket.broadcast.emit('action', { user: username, direction: 'acc_down' }); 
		//navigator.vibrate(100);
		//touchingFwd = true;
	});
	...
	{
		socket.broadcast.emit('action', { user: username, direction: 'acc_up' }); 
		//navigator.vibrate(100);
		//touchingFwd = false;
	});
	...
	{
		socket.broadcast.emit('action', { user: username, direction: 'rev_down' }); 
		//navigator.vibrate(100);
		//touchingBack = true;
	});
	...
	{
		socket.broadcast.emit('action', { user: username, direction: 'rev_up' });
		 //navigator.vibrate(100);
		 //touchingBack=false;
	});
	...
	{
		socket.broadcast.emit('action', { user: username, direction: 'turnL_down' }); 
		//navigator.vibrate(100);
		//touchingLeft=true;
	});
	...
	{
		socket.broadcast.emit('action', { user: username, direction: 'turnL_up' }); 
		//navigator.vibrate(100);
		//touchingLeft=false;
	});
	...
	{
		socket.broadcast.emit('action', { user: username, direction: 'turnR_down' }); 
		//navigator.vibrate(100);
		//touchingRight=true;
	});
	...
	{
		socket.broadcast.emit('action', { user: username, direction: 'turnR_up' }); 
		//navigator.vibrate(100);
		//touchingRight=false;
	});
